...
namespace Baibaomen.DevModel.Businsess.DBContexts
{
    public class SqlDbContext : DbContext
    {
        ...
        public void PrepareEntityToSave(BaseEntity entity,bool needConcurrencyCheck = true, string operatorId = null){
        ...
        public void PrepareEntityToDelete<TRecordVersion>(BaseEntity entity,TRecordVersion clientRecordVersion = default(TRecordVersion), string operatorId = null)
        {
